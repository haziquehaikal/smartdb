...
import com.picotech.smartdb.fragments.DeviceListFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uiManager.setCenterTitle("Dashboard");
        getSupportActionBar().setElevation(0);

        sessionPreferences = new SessionPreferences(getApplicationContext());
        Toast.makeText(getApplicationContext()
                , "Welcome " + sessionPreferences.getUserDetails().get("name")
        ...
        transaction.replace(R.id.container, DeviceListFragment.newInstance());
        transaction.commit();
    }
